...
<div class="hero-unit">
  ...
  <ul>
    <li>如何使用OpenWebFlow（基于Activiti扩展形成的Web工作流引擎，系本平台原创）和Spring MVC处理业务流程，OpenWebFlow演示如下功能：
      <ul>
        <li><b>完全非侵入式开发方式：</b>开发者可以像往常一样编写Controller，如果确实需要使用OpenWebFlow的功能，则可以在方法参数中通过注解的方式得到WebFlowHelper，参见<a href="https://github.com/sggITplatform/pmis-platform-demo/blob/master/src/main/java/demo/mvc/MyController.java" target="_blank" class="btn-primary">demo.mvc.MyController</a>；</li>
